namespace TurnTheGameOn.SimpleTrafficSystem
{
    ...
    public class Editor_AITrafficWaypointRoute : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty minSpawn = serializedObject.FindProperty("minSpawn");
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(minSpawn, true);
            if (EditorGUI.EndChangeCheck())
                serializedObject.ApplyModifiedProperties();

            SerializedProperty maxSpawn = serializedObject.FindProperty("maxSpawn");
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(maxSpawn, true);
            if (EditorGUI.EndChangeCheck())
                serializedObject.ApplyModifiedProperties();
